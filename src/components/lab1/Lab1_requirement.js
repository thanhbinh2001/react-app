      ...
      <div>
        <ul>
          ...
          <ul>
            <li>
              <p>
                Tab <strong>Requirement</strong>: copy lại nội dung của phần 1 ở
                trên <strong>(Yêu cầu)</strong> vào đây (và trình bày lại cho
                đẹp)
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                {" "}
                Tab <strong>Implement</strong>: là trang html của chức năng Quản
                lý đó
              </p>
            </li>
          </ul>
